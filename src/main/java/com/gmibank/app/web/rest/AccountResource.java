...
import com.gmibank.app.domain.Authority;
import com.gmibank.app.domain.TPAccountRegistration;
import com.gmibank.app.domain.User;
import com.gmibank.app.repository.UserRepository;
import com.gmibank.app.security.AuthoritiesConstants;
import com.gmibank.app.security.SecurityUtils;
import com.gmibank.app.service.MailService;
import com.gmibank.app.service.TPAccountRegistrationService;
import com.gmibank.app.service.UserService;
import com.gmibank.app.service.dto.PasswordChangeDTO;
import com.gmibank.app.service.dto.UserDTO;
import com.gmibank.app.web.rest.errors.EmailAlreadyUsedException;
import com.gmibank.app.web.rest.errors.InvalidPasswordException;
import com.gmibank.app.web.rest.errors.LoginAlreadyUsedException;
import com.gmibank.app.web.rest.errors.SSNAlreadyUsedException;
import com.gmibank.app.web.rest.vm.KeyAndPasswordVM;
import com.gmibank.app.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
	...
	private final TPAccountRegistrationService accountRegisterService;

	public AccountResource(UserRepository userRepository, UserService userService, MailService mailService,
			TPAccountRegistrationService accountRegisterService) {
	...
	public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
		...
		List<TPAccountRegistration> arList = accountRegisterService.findOneBySSN(managedUserVM.getSsn());
        if(!arList.isEmpty()) {
...
//        managedUserVM.setAuthorities(authorities);
		...
		ar.setSsn(managedUserVM.getSsn());
		ar.setFirstName(managedUserVM.getFirstName());
		ar.setLastName(managedUserVM.getLastName());
		ar.setAddress(managedUserVM.getAddress());
		ar.setMobilePhoneNumber(managedUserVM.getMobilePhoneNumber());
		ar.setUserId(user.getId());
		ar.setUserName(user.getLogin());
		ar.setEmail(user.getEmail());
		ar.setCreateDate(Instant.now());
		accountRegisterService.save(ar);
	}
